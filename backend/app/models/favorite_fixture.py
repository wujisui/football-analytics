...
class FavoriteFixture(Base):
    ...
    # Actual direction in auto_market (e.g. 大(2.5)); auto_lean remains the
    # companion 1X2 direction used by the compact card.
    auto_market_lean: Mapped[str | None] = mapped_column(String(64), nullable=True)
