"""Subscribed detail-enrich quota guards (no live official requests)."""

from types import SimpleNamespace

from app.services.scheduled_detail_enrich import _is_quota_error, _quota_looks_exhausted
