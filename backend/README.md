...
| `scheduled_results_sync` | 每天 **07:00**；管理员手动「只更新赛果」 | 回写【比赛】当前比赛日的昨天和今天终场比分，不拉前几天、不拉盘口/赛程/详情 |
