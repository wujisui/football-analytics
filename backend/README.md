...
| `scheduled_fixtures_sync` | 11:00 每日唯一完整批次；其余为盘口轻刷 | 未订阅另跑 22:00；已订阅跑 11:55、02/14/16/18/20，21:00–24:00 每半小时，04/06/08/10 可关闭。轻刷只处理今天未开赛热门盘口并重算日推 |
